...
const process = async () => {
  ...
  const answers = await model.findAnswers(input.value, contextDiv);
  if (answers[0].score < 1) {
    answerDiv.innerHTML = 
    "Oops...! I can't tell you that now! :) ";}
    else {
      answerDiv.innerHTML = 
      answers[0].text;
    	}
  //answers.map(answer => answer.text + ' (score =' + answer.score + ')').join('<br>');
};

window.onload = () => {
  modelPromise = qna.load();
  input = document.getElementById('form-field-question');
  search = document.getElementById('search');
  contextDiv = "Your favorite game is Hollow Knight\r\n\r\nYour favorite song is Gimme More\r\n\r\nYour favorite singer is Britney Spears\r\n\r\nYour favorite soundtrack is Octopath Traveler\r\n\r\nYou were born in a tropical island\r\n\r\nYou are from the biggest archipelago on earth\r\n\r\nYou live in Augsburg\r\n\r\nYou studied at University of Applied Sciences Esslingen\r\n\r\nYou studied media informatics\r\n\r\nYou like your job as UX Developer at Kommdirekt\r\n\r\nYour greatest achievement is learning C# from scratch and helping companies to achieve their goal using digital solutions\r\n\r\nYou chose the career part in UX or as UX Developer because of my love in technology and everyone should be able to use it effectively and efficiently.\r\n\r\nYou built this module using tensorflow.js library which is available on Github\r\n\r\nYour weakness is loving to work days and nights and then complain about work-life-balance\r\n\r\nYour strength is loving to learn new things \r\n\r\nYour don\'t have instagram\r\n\r\nYour Twitter is private because you like the privacy \r\n\r\n Your favorite movie is mean girls \r\n\r\n You think Kommdirekt is the best digital marketing agency I have worked for \r\n\r\n Your life motto is 'You better work b**ch";
